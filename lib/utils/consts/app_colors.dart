...
abstract final class AppColors{
  ...
  static const Color sportsRed = Color(0xFFDD3333);    // Sports: Red
  static const Color politicsBlue = Color(0xFF1E4A80); // Politics: Blue
  static const Color healthPink = Color(0xFFFF4081);   // Health: Pink
